...
public final class Main {
    ...
    "           [--dump-normalized-features[=<dir>]] [--nsf-tier-order \"exact,near,wl,wlrelaxed\"] [--use-nsf64=canonical|surrogate|both]\n" +
    "           [--wlRelaxedL1 <int>] [--wlSizeBand <0..1>] [--nsf-near <int>] [--stack-cos <0..1>]"
    );
